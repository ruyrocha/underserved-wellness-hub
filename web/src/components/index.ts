...
// ── Layout ───────────────────────────────────────────────────────────────────
export { AppShell, TopBar, Sidebar, NavItem } from './layout/AppShell/AppShell'
...
// ── Data Display ─────────────────────────────────────────────────────────────
export { StatusBadge, ConsentBadge } from './data-display/StatusBadge/StatusBadge'
export type { AnyStatus, CampaignStatus, MessageStatus, ConsentStatus } from './data-display/StatusBadge/StatusBadge'
...
export { EmptyState }      from './data-display/StatCard/StatCard'
export { SkeletonBlock }   from './data-display/StatCard/StatCard'
export { ActivityFeed }    from './data-display/StatCard/StatCard'
export type { FeedItem }   from './data-display/StatCard/StatCard'
