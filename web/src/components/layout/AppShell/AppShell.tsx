...
import { NavDivider } from "./NavSection";
...
export function AppShell({
  ...
  return (
    <div
      className={cn(
        "flex h-screen flex-col overflow-hidden bg-neutral-50",
        className,
      )}
    >
      {/* Fixed top bar */}
    ...
    >
      ...
      {!collapsed && (
        <>
          ...
          {badge !== undefined && (
            <span className="ml-auto rounded-full bg-red-500 px-1.5 py-px text-[10px] font-semibold text-white leading-none">
              {badge}
            </span>
          )}
        </>
...
// Re-export nav helpers from this module for convenience
export { NavSection, NavDivider };
